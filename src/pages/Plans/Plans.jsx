...
const mapFromBackendPromotions = (p) => {
  ...
  let imageUrl = p.imageUrl;
    if (imageUrl && !imageUrl.startsWith('http') && !imageUrl.startsWith('/assets')) {
      imageUrl = `https://centromasajes-backend.onrender.com${imageUrl}`;
    }
...
const Plans = () => {
  ...
  useEffect(() => {
    const loadPlans = async () => {
      ...
      try {
        const res = await axios.get('https://centromasajes-backend.onrender.com/plans');
  ...
  useEffect(() => {
    const loadPromotions = async () => {
      ...
      try {
        const res = await axios.get('https://centromasajes-backend.onrender.com/promotions');
