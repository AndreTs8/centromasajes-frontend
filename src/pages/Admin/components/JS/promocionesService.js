...
const API_URL = 'https://centromasajes-backend.onrender.com/promotions';
...
export const uploadPromotionImage = async (file) => {
    ...
    const res = await axios.post("https://centromasajes-backend.onrender.com/upload/promotion-image", formData, {
